...
?>
       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Navarathna Agrahara,Sadahalli P.O.,<br>Off Bengaluru International Airport,<br>Bengaluru - 562 110,<br>Karnataka, INDIA
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 7766932543</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email</abbr>: <a href="radhavishwakarma482@gmail.com">radhavishwakarma482@gmail.com</a>
                ...
                <ul class="list-unstyled list-inline list-social-icons">
                    <li>
                        <a href="https://www.facebook.com/profile.php?id=100009391323939"><i class="fa fa-facebook-square fa-2x"></i></a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/in/radha-raj-a64573175/"><i class="fa fa-linkedin-square fa-2x"></i></a>
                    </li>
                    <li>
                        <a href="https://twitter.com/Radhavishwakar8"><i class="fa fa-twitter-square fa-2x"></i></a>
                    </li>
                    <li>
