    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('images/feedback.jpg');background-size:auto;"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/feedback1.jpg');background-size:auto;"></div>
                <div class="carousel-caption">
			 ...
			 <div class="item">
                <div class="fill" style="background-image:url('images/feedback3.jpg');background-size:auto;"></div>
                <div class="carousel-caption">
...
<!-- slider -->			
    ...
    <div class="container">
		...
		<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				<h2> “We all need people who will give us feedback. That’s how we improve.”
			</div>
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF">Developed By ....... 	<a href="http://www.phptpoint.com">RADHA RAJ and PRATHAP M</a> </span>
	</div>
    <!-- jQuery -->
